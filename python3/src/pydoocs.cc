...
const char* PYDOOCS_DOC = "Python3 bindings to the standard DOOCS client API written in C/C++.";
const char* PYDOOCS_VERSION_ATTRIBUTE = "__version__";
const char* PYDOOCS_VERSION_NUMBER = "2.0.5";
...
/*
 * Define the pydoocs module in accordance with the Python/C API.
 */
static struct PyModuleDef pydoocs = {
